...
$products = selectAllFromProductsWithUserOnСatalog('Products', 'Topics');
...
<body>
    ...
    <div class="main-content2">
        ...
        <?php foreach ($products as $products) : ?>
            <div class="card2">
                <img src="/assets/img/7.jpg" class="card-img" alt="..." height="180">
                <div class="card-body1">
                    ...
                    <a href="/itemA.php/item1.php" class="btn btn-primary">Открыть</a>
                </div>
            </div>
        <?php endforeach; ?>
    </div>
