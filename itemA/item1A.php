...
$products = selectAllFromProductsWithUserOnItemA('Products', 'User', 'Topics');
...
<body>
    ...
    <div class="main-content1">
        ...
        <?php foreach ($products as $products) : ?>
            <div class="card1">
                <img src="/assets/img/2.jpg" class="card-img" alt="..." height="180">
                <div class="card-body1">
                    <h5 class="card-title"><?= $products['namep'] ?></h5>
                    <div class="id_topic">Категория: <?= $products['namet'] ?></div>
                    <div class="parametr">Характеристика: <?= $products['parametr'] ?></div>
                    ...
                    <a href="/app/controllers/index-basket.php" name="add_in_basket" class="btn btn-primary">В корзину</a>
                </div>
            </div>
