...
$products = selectAllFromProductsWithUserOnItemR('Products', 'User', 'Topics');
...
<body>
    ...
    <div class="main-content1">
        ...
        <?php foreach ($products as $products) : ?>
            <div class="card1">
                <img src="/assets/img/6.jpg" class="card-img" alt="..." height="180">
                <div class="card-body1">
                    ...
                    <a href="/app/controllers/index-basketR.php" class="btn btn-primary">В корзину</a>
                </div>
            </div>
        <?php endforeach; ?>
